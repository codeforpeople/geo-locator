package org.codeforbraila.amazingrace.geolocator.app;

import org.codeforbraila.amazingrace.geolocator.app.util.SystemUiHider;
 ...
 * @see SystemUiHider
 */
public class MainForm extends Activity implements GooglePlayServicesClient.ConnectionCallbacks,
    ...
    /**
     * The target locations and the current target index
     */
...
//            Log.d("Location Update", "Google Play Services available!");
//            return true;
//        }
//
//        return false;
//    }
    ...
    /**
     * Called when the client has successfully connected to the location service
     */
    @Override
    ...
    public void onLocationChanged(Location newLocation) {
        ...
        // Compute the distance and update the view
        int distance = (int) _currentLocation.distanceTo(_targetLocation);
        TextView contentView = (TextView) findViewById(R.id.fullscreen_content);
        contentView.setText(distance + " METERS");
